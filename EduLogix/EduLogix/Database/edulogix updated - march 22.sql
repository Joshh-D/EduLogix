...
INSERT INTO `reg_logs` (`name`, `role`, `action`, `log_date`) VALUES
...
INSERT INTO `reg_attendance` (`rfid_number`, `student_num`, `student_name`, `grade`, `section`, `status`, `attendance_date`, `level`) VALUES
...
-- --------------------------------------------------------
-- 5. reg_attendance_live
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `reg_attendance_live` (
  `rfid_number` varchar(255) NOT NULL,
...
-- 6. reg_dashboard
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `reg_dashboard` (
